...
LOVEDIR="$(GET_VAR "device" "storage/rom/mount")/MUOS/application/DinoJam"
...
LD_PRELOAD="$LOVEDIR/dinojam/native/linuxarm64/libjemalloc.so" ./love dinojam --project-root="$LOVEDIR" >>"$LOGFILE" 2>&1
